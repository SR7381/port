...
import { 
  Send, Mail, Phone, MapPin, MessageSquare, Loader2
} from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Ready to bring your video project to life? Reach out for a consultation or quote.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">ranasourav7381@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">+91 7209473687</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-slate-900 font-medium mb-1">Social Media</h4>
                    <div className="flex space-x-3 mt-2">
                      <a href="#" className="bg-slate-800 hover:bg-slate-900 text-white p-2 rounded-full transition-colors duration-300">
